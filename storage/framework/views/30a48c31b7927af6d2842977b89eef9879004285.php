                            ...
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 overflow-hidden">
                                    <p
                                        ...
                                        <?php echo app('translator')->get('translation.totale-membres'); ?></p>
                                </div>
                            </div>
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                                        <span class="counter-value" data-target="5595">0</span>
                                    </h4>
                                    <a href="" class="text-decoration-underline"><?php echo app('translator')->get('translation.view-all-users'); ?></a>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\mastergym\resources\views/index.blade.php ENDPATH**/ ?>