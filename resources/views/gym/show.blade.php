...
@section('content')
    ...
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-lg">
                    <img style="height: inherit;" src="{{URL::asset(Helper::getImageByEntityId($gym->id, "gyms", "profile") )}}"
                                            ...
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">{{ $gym_name }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Mobile :</th>
                                                        <td class="text-muted">{{ $gym->phone }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Location :</th>
                                                        <td class="text-muted">{{ $gym->address }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Created At</th>
                                                        <td class="text-muted">{{ $gym->gym_created_at }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
