                                    ...
                                    <div class="row align-items-center team-row">
                                        ...
                                        <div class="col-lg-4 col">
                                            <div class="team-profile-img">
                                                <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0"><img src="{{URL::asset('assets/images/services/'.($service->img_name ? $service->img_name : 'default.png')  )}}" alt="" class="member-img img-fluid d-block rounded-circle" /></div>
