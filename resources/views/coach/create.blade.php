...
@section('title') @lang('translation.add') @lang('translation.coach') @endsection
@section('css')
@endsection
@section('content')
@component('components.breadcrumb')
@slot('li_1') @lang('translation.pages') : @endslot
@slot('title') @lang('translation.Create-Coach') @endslot
@endcomponent

<form id="createCoach-form" method="POST" class="needs-validation" action="{{ route('coach_store') }}" novalidate enctype="multipart/form-data">
@csrf
    <div class="row">
        <!-- start col -->
        <div class="col-lg-8">
        ...
        <div class="text-start mb-3">
            <button type="submit" class="btn btn-success w-sm save_coach">@lang('translation.Submit')</button>
        </div>
    </div>
    <!-- end row -->
</form>
